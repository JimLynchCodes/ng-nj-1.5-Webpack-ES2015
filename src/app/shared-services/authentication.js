export class Authentication {
  constructor ($rootScope, $firebaseAuth, $firebaseObject, $location, FIREBASE_URL, $log, $state) {
    'ngInject';
...
Authentication.$inject = ['$rootScope', '$firebaseAuth', '$firebaseObject', '$location', 'FIREBASE_URL', '$log', '$state'];
